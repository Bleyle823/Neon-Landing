...
const Hero = () => {
  ...
  console.log(" actual chiquito", upcomingVideoIndex);
  /**
   * currentIndex === totalVideos - 1 ? 1 : currentIndex
   * currentIndex === 1 ? totalVideos : currentIndex - 1;
  //  */
  const previousVideoIndex =
    currentIndex === totalVideos - 1 ? currentIndex : currentIndex;

  console.log("previus-fondo", currentIndex);

  const handleMiniVdClick = () => {
    setHasClicked(true);
    // setCurrentIndex((prevIndex) => prevIndex + 1);
    setCurrentIndex(upcomingVideoIndex);
    console.log("click", upcomingVideoIndex);
  };
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 max-w-64 font-robert-regular text-blue-100">
              Your AI companion for Polymarket trading. <br /> Chat to trade,
              research markets, and manage your portfolio.
            </p>
            <Button
              id="watch-trailer"
